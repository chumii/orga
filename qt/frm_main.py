...
class Ui_frm_main(object):
    def setupUi(self, frm_main):
        ...
        self.text_log_viewer.setFont(font)
        self.text_log_viewer.setVerticalScrollBarPolicy(Qt.ScrollBarAlwaysOn)
        self.text_log_viewer.setHorizontalScrollBarPolicy(Qt.ScrollBarAlwaysOn)
        self.text_log_viewer.setLineWrapMode(QTextEdit.NoWrap)
    ...
    def retranslateUi(self, frm_main):
        ...
        self.tabs_main.setTabText(self.tabs_main.indexOf(self.tab_charaktere), QCoreApplication.translate("frm_main", u"Roster", None))
